...
///stavi izradu kapeta i njegovo slanje/retransmisiju u sentTextToChat a primanje INMSG neg se vrti u pocketSocketu
public class Klijent {
	...
	public Klijent(InetAddress host, int port, DatagramSocket dSocket, long uid, String name) {
		this.host = host;
		this.port = port;
	...
	class Posiljatelj extends SwingWorker<Void, Void> {
		...
		protected void done() {
			Klijent.this.tf.setEnabled(true);
			Klijent.this.tf.requestFocusInWindow();
		}
	}
}